 ...
 */
final class Version20260417173246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities ADD time_spent INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities DROP time_spent');
        $this->addSql('ALTER TABLE applications CHANGE score score DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
