 ...
 */
final class Version20260413095900 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities ADD deadline DATE DEFAULT NULL, ADD submitted_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE project CHANGE status status ENUM(\'PLANNED\',\'IN_PROGRESS\',\'DONE\',\'ON_HOLD\'), CHANGE priority priority ENUM(\'HIGH\',\'MEDIUM\',\'LOW\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE activities DROP deadline, DROP submitted_at');
        $this->addSql('ALTER TABLE applications CHANGE score score DOUBLE PRECISION DEFAULT \'0\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE project CHANGE status status ENUM(\'PLANNED\', \'IN_PROGRESS\', \'DONE\', \'ON_HOLD\') DEFAULT NULL, CHANGE priority priority ENUM(\'HIGH\', \'MEDIUM\', \'LOW\') DEFAULT NULL');
