 ...
 */
final class Version20260426113136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation ADD image VARCHAR(255) DEFAULT NULL, ADD is_paid TINYINT(1) DEFAULT 0 NOT NULL, ADD price_points INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE quiz_attempt CHANGE score score DOUBLE PRECISION DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE users ADD points_balance INT DEFAULT 0 NOT NULL, CHANGE role role ENUM(\'ADMIN\',\'HR\',\'CANDIDATE\'), CHANGE auth_provider auth_provider ENUM(\'LOCAL\',\'GOOGLE\')');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation DROP image, DROP is_paid, DROP price_points');
        ...
        $this->addSql('ALTER TABLE users DROP points_balance, CHANGE role role ENUM(\'ADMIN\', \'HR\', \'CANDIDATE\') DEFAULT NULL, CHANGE auth_provider auth_provider ENUM(\'LOCAL\', \'GOOGLE\') DEFAULT NULL');
    }
}
