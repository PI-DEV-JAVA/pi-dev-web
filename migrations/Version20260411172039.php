 ...
 */
final class Version20260411172039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, status ENUM(\'PLANNED\',\'IN_PROGRESS\',\'DONE\',\'ON_HOLD\'), start_date DATE DEFAULT NULL, end_date DATE DEFAULT NULL, budget NUMERIC(10, 2) DEFAULT NULL, project_manager_id INT DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE bookmarks ADD CONSTRAINT FK_78D2C14053C674EE FOREIGN KEY (offer_id) REFERENCES offers (id)');
        ...
        $this->addSql('ALTER TABLE interviews ADD CONSTRAINT FK_3A7526823E030ACD FOREIGN KEY (application_id) REFERENCES applications (id)');
